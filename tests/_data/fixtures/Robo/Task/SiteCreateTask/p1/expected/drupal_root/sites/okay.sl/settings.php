...
$databases = [
  'default' => [
    'default' => [
      'driver' => 'sqlite',
      'database' => '../sites/okay.sl/db/default__default.sqlite',
    ],
  ],
];
 ...
 */
$config_directories = [
  CONFIG_SYNC_DIRECTORY => '../sites/okay.sl/config/sync',
];
 ...
 * @endcode
 */
$settings['hash_salt'] = file_get_contents('../sites/okay.sl/hash_salt.txt');
 ...
 */
$settings['file_public_path'] = 'sites/okay.sl/files';
 ...
 */
$settings['file_private_path'] = '../sites/okay.sl/private';

$settings['file_temporary_path'] = '../sites/okay.sl/temporary';
